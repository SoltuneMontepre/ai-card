...
export default function PremiumLandingPage({
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-emerald-50/30 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-50" />
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-emerald-200/20 rounded-full blur-3xl" />
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-360 mx-auto px-8 py-20">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-emerald-50 to-blue-50 border border-emerald-200 rounded-full mb-8 shadow-sm">
                    ...
                    <>
                      <div className="relative">
                        <textarea
                          ...
                          className="w-full h-56 p-5 border-2 border-slate-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-slate-700 bg-slate-50/30"
                          placeholder="Dán nội dung bạn vừa hỏi AI (ChatGPT, Gemini...) vào đây để bắt đầu làm việc..."
                        />
                        <div className="absolute bottom-3 right-3 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-600 font-medium shadow-sm">
                          {wordCount} / 3000 từ
                        </div>
                      </div>
                      <button
                    ...
                    <>
                      ...
                      {!uploadedFile ? (
                        <div
                          ...
                          className="flex flex-col items-center justify-center h-56 border-2 border-dashed border-slate-300 rounded-xl hover:border-emerald-500 transition-all cursor-pointer bg-slate-50/30 hover:bg-emerald-50/30 group"
                        >
                        ...
                        <div className="flex items-center justify-between h-56 p-6 border-2 border-emerald-300 bg-emerald-50 rounded-xl">
                          ...
                          <button
                            ...
                            className="w-8 h-8 bg-white hover:bg-red-50 rounded-lg flex items-center justify-center transition-colors border border-slate-200"
                          >
        ...
        <section className="max-w-360 mx-auto px-8 pb-20">
          <Animated className="max-w-6xl mx-auto grid grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-2xl p-8 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-100 transition-all group">

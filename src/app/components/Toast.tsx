...
export default function Toast({ message, isVisible, onClose }: ToastProps) {
  ...
  return (
    <Animated className="fixed bottom-6 right-6 z-50">
      <div className="bg-white dark:bg-slate-900 border-2 border-emerald-500 dark:border-emerald-600 rounded-xl shadow-2xl shadow-emerald-500/20 p-4 flex items-center gap-3 min-w-[320px] animate-in slide-in-from-bottom-4 fade-in duration-300">

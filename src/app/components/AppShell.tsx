            ...
            <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 shadow-sm">
              <div className="page-container py-4">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:justify-between">
                  <div className="flex-1 max-w-2xl sm:mx-auto w-full">
                  ...
                  <button
                    ...
                    className="px-4 py-2 border-2 border-red-500 text-red-500 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/40 transition-all font-semibold shrink-0 sm:w-auto w-full"
                  >
                    Hủy phiên
                  </button>
                </div>
            ...
            <div className="bg-linear-to-r from-emerald-50 to-green-50 dark:from-emerald-950/40 dark:to-green-950/40 border-b border-emerald-200 dark:border-emerald-900 shadow-sm">
              <div className="page-container py-4">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:justify-between">
                  ...
                  <button
                    onClick={resetAndGoHome}
                    className="flex items-center justify-center gap-2 px-5 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all font-semibold shadow-md shrink-0 sm:w-auto w-full"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="flex items-center justify-center">
                  <div className="w-full max-w-135">
                    <div
                      ref={certificateRef}
                      className="relative bg-linear-to-br from-[#0F172A] to-[#1E293B] rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-12 border-4 border-emerald-500 overflow-hidden"
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-end justify-center sm:justify-between w-full gap-4 text-sm">
                          ...
                          <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center p-1.5 shrink-0">
                            <QRCode
